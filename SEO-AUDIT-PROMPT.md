...
1. Canonical: exactly one <link rel="canonical"> per page, on the primary domain.
...
- Fetch the live (or built) key file, robots.txt, and sitemap.xml to confirm they're served.
